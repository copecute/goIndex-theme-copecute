...
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/copecute/goIndex-theme-copecute/css/mdui_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/copecute/goIndex-theme-copecute/css/mdui_v2.min.css">'
  );
}
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/copecute/goIndex-theme-copecute/css/nexmoe_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/copecute/goIndex-theme-copecute/css/nexmoe_v2.min.css">'
  );
}
document.write(
  '<script src="//cdn.jsdelivr.net/gh/copecute/goIndex-theme-copecute/js/mdui.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/copecute/goIndex-theme-copecute/js/flv.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/copecute/goIndex-theme-copecute/js/DPlayer.min.js"></script>'
);
document.write(
...
<script src="//cdn.jsdelivr.net/gh/copecute/goIndex-theme-copecute/js/ace.js"></script>
<script src="//cdn.jsdelivr.net/gh/copecute/goIndex-theme-copecute/js/ext-language_tools.js"></script>
	`;
  $("#content").html(content);
